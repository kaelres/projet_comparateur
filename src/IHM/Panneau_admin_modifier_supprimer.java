...
public class Panneau_admin_modifier_supprimer extends JPanel
{
	...
	public Panneau_admin_modifier_supprimer(Fenetre_admin f)
	{
		f_admin=f;
	...
	class BoutonListenerRechercher implements ActionListener 
	{
		public void actionPerformed(ActionEvent arg0)
		{
			...
			try {
					...
					OrdiDAO_Admin dao = (OrdiDAO_Admin )Controleur.getOrdiDAO();
					...
					if 	( (tab2.get(7).isVisible() && champ_id.getText().equals("")) ) {		//prix vide => NumberFormatException ,pas a check donc
						...
						resultatRecherche = new Fenetre_resultat_admin(ordiListe);
					}
